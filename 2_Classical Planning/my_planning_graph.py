...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        a_effects = actionA.effects
        b_effects = actionB.effects
        for fxa in a_effects:
            for fxb in b_effects:
                if fxa == ~fxb:
                    return True
        return False
    ...
    def _interference(self, actionA, actionB):
        ...
        # TODO: implement this function
        a_effects = actionA.effects
        a_preconds = actionA.preconditions
        b_effects = actionB.effects
        b_preconds = actionB.preconditions
        for afx in a_effects:
            if ~afx in b_preconds:
                return True
        for bfx in b_effects:
            if ~bfx in a_preconds:
                return True
        return False
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        a_preconditions = actionA.preconditions
        b_preconditions = actionB.preconditions
        for pa in a_preconditions:
            for pb in b_preconditions:
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        pA = self.parents[literalA]
        pB = self.parents[literalB]
        for a in pA:
            for b in pB:
